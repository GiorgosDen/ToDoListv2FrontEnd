...
function Layout({triggerServerSideError}){
    ...
    return(
        ...
        <main className={mainVisibility}>
            ...
            <Outlet context={{viewMode,handleChangeViewMode,triggerServerSideError}}/>
        </main>
        </>
    );
}
