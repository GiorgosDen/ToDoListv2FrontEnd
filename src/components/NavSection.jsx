...
function NavSection({onClickSection,sectionName, iconPath}){
    return(
    <div className=" group w-[95%] pl-[2%] h-[10%] inline-flex items-center justify-start text-gray-600 rounded-sm hover:bg-blue-200 hover:text-purple-800 cursor-pointer"
